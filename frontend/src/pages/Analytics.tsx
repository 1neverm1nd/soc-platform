    ...
    <div className="p-6 space-y-5">
      ...
      <Card>
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            { label: "Architecture", main: "XGBoost + RandomForest", sub: "Soft-voting ensemble" },
            { label: "Accuracy", main: "75.7%", sub: "UNSW-NB15 test set", green: true },
            { label: "Features", main: "46", sub: "flow + 4 engineered" },
